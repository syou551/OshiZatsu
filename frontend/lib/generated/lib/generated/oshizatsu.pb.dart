...
class Channel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Channel', package: const $pb.PackageName(_omitMessageNames ? '' : 'oshizatsu'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(4, _omitFieldNames ? '' : 'lastLiveScheduled', subBuilder: $0.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $0.Timestamp get lastLiveScheduled => $_getN(3);
  @$pb.TagNumber(4)
  set lastLiveScheduled($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastLiveScheduled() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastLiveScheduled() => clearField(4);
  @$pb.TagNumber(4)
  $0.Timestamp ensureLastLiveScheduled() => $_ensure(3);
...
class AuthServiceApi {
  ...
  ;
  $async.Future<GetUserInfoResponse> getUserInfo($pb.ClientContext? ctx, GetUserInfoRequest request) =>
    _client.invoke<GetUserInfoResponse>(ctx, 'AuthService', 'GetUserInfo', request, GetUserInfoResponse())
  ;
}

class ChannelServiceApi {
  $pb.RpcClient _client;
  ChannelServiceApi(this._client);

  $async.Future<SubscribeChannelResponse> subscribeChannel($pb.ClientContext? ctx, SubscribeChannelRequest request) =>
    _client.invoke<SubscribeChannelResponse>(ctx, 'ChannelService', 'SubscribeChannel', request, SubscribeChannelResponse())
  ;
  $async.Future<UnsubscribeChannelResponse> unsubscribeChannel($pb.ClientContext? ctx, UnsubscribeChannelRequest request) =>
    _client.invoke<UnsubscribeChannelResponse>(ctx, 'ChannelService', 'UnsubscribeChannel', request, UnsubscribeChannelResponse())
  ;
  $async.Future<GetSubscribedChannelsResponse> getSubscribedChannels($pb.ClientContext? ctx, GetSubscribedChannelsRequest request) =>
    _client.invoke<GetSubscribedChannelsResponse>(ctx, 'ChannelService', 'GetSubscribedChannels', request, GetSubscribedChannelsResponse())
  ;
}
...
class NotificationServiceApi {
  ...
  $async.Future<RegisterFCMTokenResponse> registerFCMToken($pb.ClientContext? ctx, RegisterFCMTokenRequest request) =>
    _client.invoke<RegisterFCMTokenResponse>(ctx, 'NotificationService', 'RegisterFCMToken', request, RegisterFCMTokenResponse())
  ;
  $async.Future<UnregisterFCMTokenResponse> unregisterFCMToken($pb.ClientContext? ctx, UnregisterFCMTokenRequest request) =>
    _client.invoke<UnregisterFCMTokenResponse>(ctx, 'NotificationService', 'UnregisterFCMToken', request, UnregisterFCMTokenResponse())
  ;
