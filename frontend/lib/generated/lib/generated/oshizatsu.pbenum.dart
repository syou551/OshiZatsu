...
class NotificationType extends $pb.ProtobufEnum {
  static const NotificationType SCHEDULED = NotificationType._(0, _omitEnumNames ? '' : 'SCHEDULED');
  static const NotificationType STARTED = NotificationType._(1, _omitEnumNames ? '' : 'STARTED');
